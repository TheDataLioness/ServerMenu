...
class Main extends PluginBase
{
    ...
    public function onEnable():
        void
        {
            ...
            $standard_vals = ["servers" => [["name" => "LocalHost", "ip" => "127.0.0.1", "port" => "19132"], ["name" => "Example Server", "ip" => "play.example.com", "port" => "19132"], ], ];
        ...
        public function onCommand(CommandSender $sender, Command $command, string $label, array $args):
            ...
            public function onDisable():
                ...
                public function serverMenu(Player $player):
                    void
                    {
                        $options = array();
                        foreach ($this
                            ->config
                            ->get("servers") as $server)
                        {
                            $options[] = $server["name"];
                        }
